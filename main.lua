...
loadstring(game:HttpGet("https://sphinx-checker.vercel.app/api/module?name=leveling",true))()
loadstring(game:HttpGet("https://sphinx-checker.vercel.app/api/module?name=nightmare",true))()
