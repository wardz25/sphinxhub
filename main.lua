...
local v12=v11.Pets
local v13=v11.Boost
local v14=loadstring(game:HttpGet("https://raw.githubusercontent.com/wardz25/updater/refs/heads/main/SphinxMainLibrary.lua"))()
...
local v27="https://sphinx-checker.vercel.app/api/t"
local v28="https://sphinx-checker.vercel.app/api/load-tracker?token=" .. v26
...
end local v42="SphinxX_Session.json"
...
if ( not v310 or (v310=="")) then return
    ...
    local v2407=v3:JSONEncode({username=v7.Name,avatar_url="https://raw.githubusercontent.com/wardz25/updater/refs/heads/main/sphinx.png",content=(v2406 and "@everyone") or nil ,embeds=v309})
...
if not v1373 then warn("[SphinxHub Webhook]",v1374)
end end)
end local v70={}
...
v69({{title="✅ Pet Finished!",color=5763719,description=string.format("**%s** has reached **Level 100**!\n%s",v330,v337),fields={{name="⚖️ Final Base",value=string.format("**%.3f** kg",v331),inline=true},{name="🎯 Queue",value=string.format("%d / %d done",v334 or 0 ,v335 or 0 ),inline=true},{name="🏁 Total Time",value=v14.fmtTime(v332),inline=false},{name="⚡ Phase 2 Time",value=v14.fmtTime(v333),inline=true},{name="🐢 Phase 1 Time",value=v14.fmtTime(v332-v333 ),inline=true}},footer={text="Sphinx Hub 🐉 • " .. os.date("%d/%m/%Y %H:%M:%S") },thumbnail={url="https://raw.githubusercontent.com/wardz25/updater/refs/heads/main/sphinx.png"}}})
end local function v73() v69({{title=" Sphinx Hub — Connection Test",color=5793266,description="Webhook Connected!",fields={{name="✅ Status",value="Online",inline=true},{name="🕐 Time",value=os.date("%H:%M:%S"),inline=true},{name="👤 Player",value=v7.Name,inline=true}},footer={text=" Sphinx Hub • vX"}}})
...
v346=v346 or "https://raw.githubusercontent.com/wardz25/updater/refs/heads/main/sphinx.png"
local v347=v338
...
end local v105=(function() local _ok,_r=pcall(function() return require(v2.Data.PetRegistry.PetBoostRegistry) end);return _ok and _r or {} end)()
...
return v417
end pcall(function() v4:FindFirstChild("SphinxHubUI"):Destroy()
end)
local v109=Instance.new("ScreenGui")
v109.Name="SphinxHubUI"
...
v16:label(v124,"SPHINX HUB",UDim2.new(1, -80,1,0),UDim2.new(0,34,0,0),v15.TEXT,12)
...
local v1532={}
do local v2457={}
    local v2458,v2459=pcall(function() return game:HttpGet("https://raw.githubusercontent.com/wardz25/updater/refs/heads/main/fruits.json")
    end)
...
v1645.TextColor3=v15.DIM
continue
end end _G.SphinxHub_GiftingActive=true
v3681.Parent=v9
task.wait(1)
...
_G.SphinxHub_GiftingActive=false
end task.wait(1)
end v1645.Text="● IDLE"
v1645.TextColor3=v15.DIM
...
if not v2522 then _G.SphinxHub_GiftingActive=false
